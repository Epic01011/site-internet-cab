      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1">
            ...
            {/* Map embed */}
            <div className="mt-8 rounded-xl overflow-hidden shadow-md border border-gray-100 h-64 relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.137839352697!2d2.3080517!3d48.8795553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66fccbb13d467%3A0x6bbaaba7ef520d!2s58%20Rue%20de%20Monceau%2C%2075008%20Paris!5e0!3m2!1sfr!2sfr!4v1710411300000!5m2!1sfr!2sfr"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Google Maps - Hayot Expertise"
              />
            </div>
          </aside>
